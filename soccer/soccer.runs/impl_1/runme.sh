...
HD_PWD='C:/Users/abominus/Desktop/soccer/soccer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soccer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soccer.tcl -notrace
