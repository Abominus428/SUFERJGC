...
HD_PWD='C:/Users/abominus/Desktop/soccer/soccer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soccer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soccer.tcl
